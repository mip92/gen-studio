...
import { ImageEngineFactory } from './images/image-engine.factory';
...
@Module({
  ...
  exports: [DatasetQueueService, SceneRenderService, VideoRenderService, EndFrameService, ImageEngineFactory],
})

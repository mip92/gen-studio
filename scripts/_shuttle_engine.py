# -*- coding: utf-8 -*-
"""Shot engine for shuttle («ТЫ — Челночница»). graphic_novel_flux, divorce look (Comic_Style-FLUX LoRA).
Track B semi-light (hard years, proud ending), f5 female. Same upgrades as collector/lottery engines.
...
ROUTE_C="shuttle_character_ip"; ROUTE_E="shuttle_environment"
...
OBJECTS={
 "bag":"a huge red-white-blue plaid shuttle bag patched in four places with careful stitches, a Turkish market tag on the handle",
 "belt":"a homemade cloth money belt sewn from a man's old checked shirt, worn soft, a button pocket over the seam",
 "ledger":"a thick oilcloth-covered notebook of turnover sums, pencil columns packed tight, corners rounded by hands",
}

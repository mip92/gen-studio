# -*- coding: utf-8 -*-
"""Sync collector_scriptText.md -> projects.scriptText (no PATCH endpoint; documented exception)."""
import os, psycopg2
...
cur.execute('UPDATE projects SET "scriptText"=%s, "updatedAt"=now() WHERE slug=%s',(script,"collector"))

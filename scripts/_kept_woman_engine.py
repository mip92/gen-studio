# -*- coding: utf-8 -*-
"""Shot engine for kept_woman («ТЫ — Содержанка»). Mirrors _divorce_engine, STYLE=flux glossy glamour-noir.
Track B, 2nd person, f5 (female). §5.3a: env (no participant) shots -> renderMode='static' always.
BATCH RULES: nameless country, no currency named, silent B-roll inserts allowed (narr='').
seed_act(scene_key, palette, shots, render_mode='static', id_region='0')
  ...
  ch: None=env | profileCode (VIKA_YOUNG / VIKA_MID / VIKA_OLD / ARTUR_BASE / LERA_MID / ...)
"""
import json, psycopg2
PFX="7e630000-0000-4000-8000-"; PROJ=PFX+"000000000001"
ROUTE_C="kept_woman_character_ip"; ROUTE_E="kept_woman_environment"

STYLE=("modern cinematic graphic-novel illustration, glossy fashion comic book panel, bold confident black ink outlines with clean variable line weight, "
 "flat cell-shaded coloring with sleek soft gradients, rich but cold cinematic color grade, gold and glass highlights, glamorous noir mood, "
 "semi-realistic elegant proportions, 16:9 cinematic composition, no photorealism, no 3D render, no plastic skin, ")
TECH=("hard black ink outline on every edge, flat cell-shaded color blocks with sleek soft shading, ")
ENV_MOT=("only ambient environmental motion, slow drifting dust in a shaft of light, gently shifting reflected city light and shadow, "
 "a faint stir of sheer curtains, an empty still scene with no people and no figures, the illustration barely coming to life, hand-drawn animation cadence")

# -*- coding: utf-8 -*-
"""Shot engine for donor («ТЫ — Донор»). cell_shaded (EldritchComicsXL1.2), COOL CLINICAL comic.
...
ROUTE_C="donor_character_ip"; ROUTE_E="donor_environment"

STYLE=("cinematic graphic novel illustration, illustrated comic book panel, cell-shaded coloring, "
 "hard clean black ink outline with even line weight, cold clinical lighting, desaturated cool color blocks "
 "with fine cross-hatching, sterile blue-grey shadows, 16:9 cinematic composition, no photorealism, no 3D render, "
 "no plastic skin, cool clinical graphic-novel aesthetic, ")
TECH=("hard clean black ink outline on every edge, flat cool cell-shaded color blocks with fine cross-hatching in the shadows, ")
ENV_MOT=("only ambient environmental motion, slow drifting dust in cold light, gently shifting sterile blue-grey light and shadow, "
 "a faint flicker of a fluorescent tube, an empty still scene with no people and no figures, the illustration barely coming to life, hand-drawn animation cadence")

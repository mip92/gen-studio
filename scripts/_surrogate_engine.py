# -*- coding: utf-8 -*-
"""Shot engine for surrogate («ТЫ — Суррогатная мать»). cell_shaded (Eldritch_Classic), soft classic comic.
...
ROUTE_C="surrogate_character_ip"; ROUTE_E="surrogate_environment"
...
ENV_MOT=("only ambient environmental motion, slow drifting dust in soft light, gently shifting warm domestic light and shadow, "
 "a faint stir of a curtain, an empty still scene with no people and no figures, the illustration barely coming to life, hand-drawn animation cadence")

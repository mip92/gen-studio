# -*- coding: utf-8 -*-
"""Shot engine for divorce («ТЫ — Разведённый»). Mirrors _layoff_engine, STYLE=flux modern-comic.
...
seed_act(scene_key, palette, shots, render_mode='static', id_region='0')
  ...
  ch: None=env | profileCode (MUZH_MAIN / ZHENA_BASE / ...)
"""
import json, psycopg2
PFX="7e620000-0000-4000-8000-"; PROJ=PFX+"000000000001"
ROUTE_C="divorce_character_ip"; ROUTE_E="divorce_environment"
...
ENV_MOT=("only ambient environmental motion, slow drifting dust motes in soft light, gently shifting domestic light and shadow, "

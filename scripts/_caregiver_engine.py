# -*- coding: utf-8 -*-
"""Shot engine for caregiver («ТЫ — Сиделка»). realcomic_qwen scenes + FLUX anchors.
...
ROUTE_C = "caregiver_character_ip"
ROUTE_E = "caregiver_environment"
...
OBJECTS = {
    "bell":       "a small tarnished brass hand bell with a worn wooden handle, its lip dented on one side, standing on a crocheted doily",
    "watchpin":   "a round nurse's fob watch on a bar pin, its enamel face crazed with fine cracks and the second hand still moving",
    "pillbox":    "a long plastic pill organiser with seven hinged compartments, each lid marked with a raised number, tablets sorted by colour inside",
    "ring":       "a thin worn gold wedding band hanging loose on a very thin elderly finger, the skin dry and translucent around it",
    "will":       "a typed single-sheet notarial document with a round embossed stamp in the corner and one signature at the foot",
    "flatkeys":   "two keys on a bent split ring with a strip of masking tape wound round it, a flat number written on the tape",
    "photoframe": "a small chipped frame holding a black-and-white wedding photograph of a young couple, the glass clouded at the edges",
    "notebook":   "a squared school exercise book filled with dated columns of blood-pressure readings in a careful nurse's hand",
    "cookietin":  "a dented biscuit tin painted with faded flowers, its lid slightly sprung, held shut by a perished rubber band",
    "slippers":   "a pair of trodden-down felt slippers set square beside the leg of a bed, the heels flattened completely",
}
...
ENV_GUARD = (", with only ambient environmental motion, dust drifting in the light, curtains and net stirring faintly, slow shifting daylight, "
